...
class AndroidPermissionManager {
  ...
  /// Request auto start permission for different brands of phones
  static Future<bool> requestAutoStartPermission() {
    if (isDesktop || isWeb) {
      return Future.value(true);
    }
    return gFFI.invokeMethod("request_auto_start_permission", null).then((value) => value ?? false);
  }
