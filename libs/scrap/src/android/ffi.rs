...
#[no_mangle]
pub extern "system" fn Java_ffi_FFI_e4807c73c6efa1e8<'a>(
    mut env: JNIEnv<'a>,
    _class: JClass<'a>,
...
#[no_mangle]
pub extern "system" fn Java_ffi_FFI_e4807c73c6efa1e2<'a>(
    mut env: JNIEnv<'a>,
    _class: JClass<'a>,
    new_buffer: JObject<'a>,  
    global_buffer: JObject<'a> 
...
#[no_mangle]
pub extern "system" fn Java_ffi_FFI_e31674b781400507<'a>(
    mut env: JNIEnv<'a>,
    _class: JClass<'a>,
    bitmap: JObject<'a>,
    scale_x: jint,
